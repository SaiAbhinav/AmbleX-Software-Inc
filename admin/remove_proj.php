                    ...
                    <ul id="manul" class="nav nav-list tree bullets" style="margin-top:-8px;">
						...
						<li style="display:none;"><a class="tree-toggle" style="cursor:pointer;"><i class="pe-7s-albums"></i><p>Manage Project</p></a>
							<ul class="nav nav-list tree bullets" style="margin-top:-8px;">
								...
								<li><a href="remove_proj.php"><p>Cancel Project</p></a></li>
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Cancel Project</a>
                </div>
			...
			if(mysqli_num_rows($proj_res) > 0) {
				...
				echo "<thead>
						<tr style='border-top: 1px solid lightgrey;'>
							<th style='padding-left: 17px;'><h5><b>Project ID</h5></b></th>
							<th><h5><b>Project Name</h5></b></th>
							<th><h5><b>Project Head</h5></b></th>
							<th><h5><b>Deadline</h5></b></th>										
							<th><h5><b>Status</h5></b></th>
							<th><h5><b>Remarks <i class='fa fa-pencil-square-o'></i></h5></b></th>
							<th><h5><b>Cancel</h5></b></th>
						</tr>
					  </thead>
					  <tbody id='myTable'>";
				while($row = mysqli_fetch_assoc($proj_res)){
					echo "<form method='post' action='../scripts/del_proj.php'>
							<tr>
								<td>".$row['proj_id']."<input type='text' style='visibility:hidden;' size='1' name='projid' value='".$row['proj_id']."'></td>
								<td>".$row['proj_name']."</td>
								<td>".$row['proj_head']."</td>											
								<td>".$row['deadline']."</td>
								<td>".$row['status']."</td>
								<td><input type='text' name='remark' value='".$row['remarks']."'></td>
								<td><button id='del'type='submit' class='btn btn-danger btn-fill btn-sm'><i class='fa fa-times'></i></button></td></tr></form>";								
				}
