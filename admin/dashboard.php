	...
	<div class="wrapper">
		...
		<div class="sidebar" data-color="grey" data-image="../images/back.jpg">
			<div class="sidebar-wrapper">
				<div class="logo">
					<a href="../index.html" class="simple-text" target="_new">AmbleX Software Inc.</a>
				</div>
				<ul class="nav">
					<li class="active">
		...
		<div class="main-panel">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse">					
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown"><a href="#" type="button" class="dropdown-toggle btn" data-toggle="dropdown"><p>Account </i><b class="caret"></b></p></a>
			...
			<div id="parent">
				<div id="wrapper" style="position:relative;">
					<iframe style="position:absolute;top:0px;width:100%;height:100vh;" scrolling="no" frameborder="0" src="../sticky/dashboard.php"></iframe>
				</div>
			</div>
		</div>
	</div>
