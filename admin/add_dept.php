...
<div class="wrapper">
	...
	<div class="main-panel">
		<nav class="navbar navbar-default navbar-fixed">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">Add Department</a>
				</div>
		...
		<div>
			<form method="post" action="../scripts/add_dept.php">
										...
										<div class="row">
											...
											<div class="col-md-3" style="margin-top:2%;">
												<div class="form-group">
													...
													<input name="add_id" type="text" class="form-control" placeholder="Department ID" required>
												</div>
											</div>
											<div class="col-md-5" style="margin-top:2%;">
												<div class="form-group">
													<label>Name <span style="font-size:12px; color:red;">*</span></label>
													<input name="add_name" type="text" class="form-control" placeholder="Department Name" >
												</div>
											</div>
											<div class="col-md-3" style="margin-top:2%;">
												<div class="form-group">
													<label>Building <span style="font-size:12px; color:red;">*</span></label>
													<input name="add_build" type="text" class="form-control" placeholder="Building Name" >
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-md-4" style="margin-top:2%;">
												<div class="form-group">
													...
													<input name="add_head" type="text" class="form-control" placeholder="Employee ID" >
												</div>
											</div>																					
										</div>
									</div>	
							...
							<div class="col-md-4">
								<div class="well">
										...
										<div class="form-group" style="padding: 15px; padding-bottom:0px;">									
											<input name="add_div1" type="text" class="form-control" placeholder="Division 1" value="">
										</div>
										<div class="form-group" style="padding: 15px; padding-top:0px; padding-bottom:0px;">									
											<input name="add_div2" type="text" class="form-control" placeholder="Division 2" value="">
										</div>
										<div class="form-group" style="padding: 15px; padding-top:0px; padding-bottom:0px;">									
											<input name="add_div3" type="text" class="form-control" placeholder="Division 3" value="">
										</div>										
									</div>
